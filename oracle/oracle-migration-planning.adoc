...
Par exemple, la copie d'une base de données de 10 To nécessite généralement environ sept heures pour être terminée. Si les besoins métier permettent une interruption de service de sept heures, la copie de fichiers est une option simple et sûre pour la migration. Si cinq heures sont inacceptables, un processus simple de réplication des journaux (voir link:oracle-migration-log-shipping.html["Envoi de journaux Oracle"]) peut être mis en place avec un minimum d'effort pour réduire le temps de basculement à environ 15 minutes. Pendant ce temps, un administrateur de base de données peut terminer le processus. Si 15 minutes sont inacceptables, le processus final de basculement peut être automatisé par script pour réduire le temps de basculement à seulement quelques minutes. Vous pouvez toujours accélérer une migration, mais cela se fait au prix de temps et d'efforts supplémentaires. Les objectifs de temps de basculement doivent être définis en fonction de ce qui est acceptable pour l'entreprise.
