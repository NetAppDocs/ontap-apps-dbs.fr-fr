...
. Partitionnez les LUN et vérifiez qu'elles sont correctement alignées. Consultez link:oracle-notes-wafl-alignment-verification.html["Alignement WAFL"] pour obtenir des instructions sur la façon de tester et de confirmer directement l'alignement.
