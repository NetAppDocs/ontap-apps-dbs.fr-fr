...
Les performances NFS sous Linux dépendent d'un paramètre appelé `tcp_max_slot_table_entries`. Veuillez consulter le link:../../common/storage-configuration/nfs.html["NFS"] pour les informations critiques.
