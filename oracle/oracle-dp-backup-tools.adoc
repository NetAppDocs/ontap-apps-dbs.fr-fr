...
[role="lead"]
La principale valeur d'ONTAP dans un environnement de base de données Oracle provient des technologies de base d'ONTAP telles que les copies Snapshot instantanées, la réplication simple SnapMirror et la création efficace de volumes clonés, de LUN et d'espaces de noms.
