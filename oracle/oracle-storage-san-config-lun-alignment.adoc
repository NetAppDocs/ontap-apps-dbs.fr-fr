...
L'alignement dans les environnements Solaris est plus complexe. Consultez  https://kb.netapp.com/on-prem/ontap/da/SAN/SAN-KBs/How_to_identify_unaligned_IO_on_LUNs["Comment identifier les E/S non alignées sur les LUN"] pour plus d'informations.
