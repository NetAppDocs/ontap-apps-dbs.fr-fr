...
Les snapshots sont une fonctionnalité clé d'ONTAP, permettant de créer des copies instantanées de vos données. Ils sont peu gourmands en espace et peuvent être créés rapidement, ce qui les rend idéaux pour la protection des machines virtuelles et des datastores. Les snapshots peuvent être utilisés à diverses fins, notamment la sauvegarde, la restauration et les tests. Ces snapshots diffèrent des snapshots (de cohérence) VMware et conviennent à une protection à plus long terme. Les snapshots gérés par VMware via vCenter sont recommandés uniquement pour une utilisation à court terme en raison de leur impact sur les performances et autres effets. Consultez  https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/9-1/vsphere-virtual-machine-administration/managing-virtual-machines/using-snapshots-to-manage-virtual-machines/snapshot-file-names-and-description.html["Fichiers Snapshot et limitations"^] pour plus de détails.
...
Pour plus d'informations sur les instantanés, consultez la documentation ONTAP . Les liens suivants fournissent des informations supplémentaires : https://docs.netapp.com/us-en/ontap/data-protection/manage-local-snapshot-copies-concept.html["Copies Snapshot locales ONTAP"^] https://docs.netapp.com/us-en/ontap/data-protection/snapmirror-replication-workflow-concept.html["Flux de travail de réplication ONTAP SnapMirror"^]
