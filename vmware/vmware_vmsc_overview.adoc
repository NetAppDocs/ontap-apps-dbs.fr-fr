...
Pour plus d'informations sur les avantages de la conception et du déploiement symétriques ou asymétriques, consultez le https://docs.netapp.com/us-en/ontap/smbc/index.html["Documentation de synchronisation active SnapMirror"].
