...
Consultez  https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0/vsphere-availability/creating-and-using-vsphere-ha-clusters/creating-a-vsphere-ha-cluster/create-vsphere-ha-cluster.html["Créez un cluster HA vSphere dans le client vSphere"] pour configurer la haute disponibilité de vCenter.
...
Pour plus d'informations sur les recommandations de conception pour vSphere Metro Storage Cluster, vous pouvez consulter les guides de solutions suivants :

* https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vmsc-with-smas.html["Cluster de stockage Metro VMware vSphere avec synchronisation active SnapMirror"]
* https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vcf-vmsc-mgmt-mcc.html["Configurez un cluster étendu pour un domaine de gestion VCF à l'aide de MetroCluster"]
* https://docs.netapp.com/us-en/netapp-solutions-virtualization/vmware/vmw-vcf-vmsc-viwld-mcc.html["Configurez un cluster étendu pour un domaine de charge de travail VCF à l'aide de MetroCluster"]
