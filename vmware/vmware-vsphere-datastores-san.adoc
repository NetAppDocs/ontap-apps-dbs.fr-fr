...
* Pour en savoir plus sur l'utilisation de NVMe/FC avec vSphere 7.0, consultez ceci https://docs.netapp.com/us-en/ontap-sanhost/nvme_esxi_7.html["Guide de configuration d'hôte NVMe/FC de ONTAP"^] et https://www.netapp.com/pdf.html?item=/media/10681-tr4684.pdf["TR-4684"^]. La figure suivante illustre la connectivité multipath d'un hôte vSphere vers un LUN ONTAP.
