...
| NewSyncInterval | Si vous n'utilisez pas le vSphere CSI pour Kubernetes, configurez par https://knowledge.broadcom.com/external/article/415074/reducing-or-disabling-excessive-vsan-cns.html["VMware KB 415074"^] | Non 
