...
image:vvols-image5.png["Architecture VASA Provider des outils ONTAP"]
...
image:vvols-image6.png["Tableau de bord vVols des outils ONTAP"]
...
image:vvols-image7.gif["Segmentation à un seul initiateur avec quatre nœuds"]
...
image:vvols-image18.png["Configuration réseau utilisant vVols sur NFS v3"] 
|===
