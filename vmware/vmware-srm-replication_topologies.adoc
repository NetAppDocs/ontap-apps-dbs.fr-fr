...
Pour obtenir les informations les plus récentes concernant SnapMirror et SnapVault pour ONTAP 9, consultez https://www.netapp.com/pdf.html?item=/media/17229-tr-4015-snapmirror-configuration-ontap.pdf["Tr-4015 Guide des meilleures pratiques en matière de configuration de SnapMirror pour ONTAP 9."^]
