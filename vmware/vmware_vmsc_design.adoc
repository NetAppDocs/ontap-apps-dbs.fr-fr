...
image::../media/vmsc_3_1.png[Capture d'écran d'une description d'ordinateur générée automatiquement,624,302]
...
image::../media/vmsc_3_2.png[Capture d'écran d'une description d'ordinateur générée automatiquement,624,475]
...
image::../media/vmsc_3_3.png[Capture d'écran d'une description d'ordinateur générée automatiquement,624,480]
...
image::../media/vmsc_3_4.png[Capture d'écran d'une description d'ordinateur générée automatiquement,624,479]
...
image::../media/vmsc_3_9.png[Gros plan d'un texte Description générée automatiquement,528,94]
...
image::../media/vmsc_3_10.png[Capture d'écran d'une description d'ordinateur générée automatiquement,624,241]

. Sélectionnez le cluster HA et cliquez sur Next.


image::../media/vmsc_3_11.png[Capture d'écran d'une description d'ordinateur générée automatiquement,624,149]

. Sélectionnez les datastores appartenant au site A et cliquez sur Suivant.


image::../media/vmsc_3_12.png[Capture d'écran d'une description d'ordinateur générée automatiquement,624,134]
