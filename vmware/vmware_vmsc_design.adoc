...
Le plugin ONTAP tools vCenter offre une méthode simple et intuitive pour configurer la synchronisation active SnapMirror pour vMSC. Vous pouvez utiliser le plugin ONTAP tools vCenter pour créer et gérer des relations de synchronisation active SnapMirror entre deux clusters ONTAP. Ce plugin propose une interface facile à utiliser pour établir et gérer efficacement ces relations. Vous pouvez en savoir plus sur le plugin ONTAP tools vCenter à  https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere-10/index.html["Les outils ONTAP pour VMware vSphere"], ou commencer directement à  https://docs.netapp.com/us-en/ontap-tools-vmware-vsphere-10/protect/granular-datastore-protection-concept.html["Critères d'éligibilité à la protection granulaire des datastores dans les outils ONTAP"].
