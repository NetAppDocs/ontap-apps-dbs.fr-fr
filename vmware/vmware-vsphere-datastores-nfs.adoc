...
* Comme mentionné dans link:vmware-vsphere-settings.html["paramètres"], si vous n'utilisez pas le vSphere CSI pour Kubernetes, vous devez définir le newSyncInterval par  https://knowledge.broadcom.com/external/article/415074/reducing-or-disabling-excessive-vsan-cns.html["VMware KB 415074"^]
