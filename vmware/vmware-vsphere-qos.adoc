...
NOTE: vVols nécessite l'utilisation des ONTAP tools for VMware vSphere, qui fonctionnent comme le fournisseur VASA pour ONTAP. Consultez link:vmware-vvols-overview.html["VMware vSphere Virtual volumes (vVols) avec ONTAP"] pour les bonnes pratiques vVols.
